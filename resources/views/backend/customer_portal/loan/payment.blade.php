                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control float-field" name="late_penalties" id="late_penalties" value="{{ date('Y-m-d') > $loan->next_payment->getRawOriginal('repayment_date') ? $loan->next_payment->penalty : 0 }}" readonly="true">
