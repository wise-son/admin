    ...
    <div class="row p-2">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text">{{ $deposit_method->currency }}</span>
                    </div>
        ...
        <div class="col-md-12 mb-2">
            <h6 class="text-danger text-center"><b>{{ decimalPlace($deposit_method->fixed_charge, currency($deposit_method->currency)) }} + {{ $deposit_method->charge_in_percentage }}% {{ _lang('transaction charge will be applied') }}</b></h6>
        </div>
