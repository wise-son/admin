								...
								<span class="dropdown">
								  ...
								  <form action="{{ action('TestimonialController@destroy', $testimonial['id']) }}" method="post">
									...
									<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
										<a href="{{ action('TestimonialController@edit', $testimonial['id']) }}" data-title="{{ _lang('Update Testimonial') }}" class="dropdown-item dropdown-edit ajax-modal"><i class="ti-pencil-alt"></i>&nbsp;{{ _lang('Edit') }}</a>
