								...
								<span class="dropdown">
								  ...
								  <form action="{{ action('ServiceController@destroy', $service['id']) }}" method="post">
									...
									<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
										<a href="{{ action('ServiceController@edit', $service['id']) }}" data-title="{{ _lang('Update Service') }}" class="dropdown-item dropdown-edit ajax-modal"><i class="ti-pencil-alt"></i>&nbsp;{{ _lang('Edit') }}</a>
										<a href="{{ action('ServiceController@show', $service['id']) }}" data-title="{{ _lang('Service Details') }}" class="dropdown-item dropdown-view ajax-modal"><i class="ti-eye"></i>&nbsp;{{ _lang('View') }}</a>
