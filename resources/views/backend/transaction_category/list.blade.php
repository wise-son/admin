					    ...
					    <tr data-id="row_{{ $transactioncategory->id }}">
							...
							<td class="text-center">
								<span class="dropdown">
								  ...
								  <form action="{{ action('TransactionCategoryController@destroy', $transactioncategory['id']) }}" method="post">
									{{ csrf_field() }}
									<input name="_method" type="hidden" value="DELETE">

									<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
										<a href="{{ action('TransactionCategoryController@edit', $transactioncategory['id']) }}" data-title="{{ _lang('Update Category') }}" class="dropdown-item dropdown-edit ajax-modal"><i class="ti-pencil-alt"></i>&nbsp;{{ _lang('Edit') }}</a>
										<a href="{{ action('TransactionCategoryController@show', $transactioncategory['id']) }}" data-title="{{ _lang('Category Details') }}" class="dropdown-item dropdown-view ajax-modal"><i class="ti-eye"></i>&nbsp;{{ _lang('View') }}</a>
